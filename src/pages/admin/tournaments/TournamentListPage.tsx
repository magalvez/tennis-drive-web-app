        ...
        <div className="space-y-10 animate-fade-in">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                <div>
                    ...
                    <p className="text-gray-500 font-bold uppercase text-[10px] tracking-widest mt-1">Manage Your Club Events & Rankings</p>
                </div>
                <button
            ...
            <div className="grid grid-cols-1 gap-4">
                {tournaments.length === 0 ? (
                    <div className="glass p-20 rounded-[40px] border-dashed border-2 border-white/10 flex flex-col items-center justify-center text-center">
                        ...
                        <h3 className="text-white text-2xl font-bold mb-2">No Tournaments Found</h3>
                        <p className="text-gray-500 max-w-md">Get started by creating your first club tournament and inviting players.</p>
                    </div>
                ) : (
                        ...
                        >
                            ...
                            <div className="flex items-center gap-10 w-full md:w-auto justify-between md:justify-end">
                                <div className="text-right space-y-1">
                                    <p className="text-gray-600 font-bold uppercase text-[9px] tracking-widest">Entry Fee</p>
